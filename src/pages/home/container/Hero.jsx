  ...
  return (
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
        <div className="mt-10 lg:w-1/2">
            ...
            <p className='text-dark-light mt-4 text-center md:text-xl lg:text-base xl:txet-xl lg:text-left'>
        ...
        <button className='w-full text-white bg-primary text-whit font-semibold rounded-lg px-5 py-3 md:absolute md:right-2 md:top-1/2 md:-translate-y-1/2 md:w-fit md:py-2'>
            search
            </button>
        </div>
